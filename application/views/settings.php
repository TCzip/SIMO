	<div class="container"><!-- Conte̼do -->
	  <div>
        ...
        <?php
		    ...
		    if ($this->session->userdata['idPermission'] == 2) {
      	...
      	?>
		    ...
		    <div class="tab-content">
		        <div class="<?php if($this->session->userdata['idPermission'] == 1) {echo"tab-pane active";}elseif ($tab ==1) {echo"tab-pane active";}else{echo"tab-pane";}?>" id="tabAlterarSenha">
		            <br>
		        ...
		        <div class="<?php if($this->session->userdata['idPermission'] == 2 && $tab==2){echo"tab-pane active";}else{echo"tab-pane";}  ?>" id="tabCadastrarNovoUsuario">
		        	<br>
